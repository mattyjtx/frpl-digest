      ...
      <div className="py-12 lg:py-24 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <MotionH2
            ...
            className="font-bold text-xl uppercase mb-4 text-teal-500"
          >
            How it works
          </MotionH2>
          <MotionH3
...
function StepItem({ icon, label, description }: Step) {
  return (
    <div className="relative p-6 rounded-2xl bg-white/5 backdrop-blur-xs border border-white/10 hover:border-teal-500/50 transition-colors group w-full">
      <div className="flex flex-col gap-4 h-full">
        <div className="flex items-center justify-center h-24 w-24 mx-auto rounded-2xl bg-linear-to-br from-teal-500/10 to-transparent group-hover:from-teal-500/20 transition-colors">
