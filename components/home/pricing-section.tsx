      ...
      >
        ...
        >
          <Link
            href={paymentLink}
            className={cn(
              'w-full rounded-full flex items-center justify-center gap-2 bg-linear-to-r from-teal-800 to-teal-500 hover:from-teal-500 hover:to-teal-800 text-white border-2 py-2',
              id === 'pro'
                ? 'border-teal-900'
  ...
  return (
    ...
    >
      <div className="py-12 lg:py-24 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 lg:pt-12">
        ...
        >
          <h2 className="uppercase font-bold text-xl mb-8 text-teal-500">
            Pricing
          </h2>
        </MotionDiv>
